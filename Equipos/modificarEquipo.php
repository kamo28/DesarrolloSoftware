...
<head>
    ...
    <div class="container">
        ...
        <div class="btn-group btn-group-lg">
            ...
            <a class="btn btn-primary  btn-lg active" aria-pressed="true" href="/DesarrolloSoftware/Equipos/modificarEquipo.php" role="button">Cambio de datos de equipo de laboratorio</a>
        ...
        if(isset($_POST['cambiar']) && !empty($_POST["clave"]) && !empty($_POST["larga"]) && !empty($_POST["corta"]) && !empty($_POST["marca"]) && !empty($_POST["modelo"]) && !empty($_POST["serie"]) && !empty($_POST["proveedor"]) && !empty($_POST["adquisicion"]) && !empty($_POST["garantia"]) && isset($_POST["ubicacion"]) && isset($_POST["responsable"]) && isset($_POST["mantenimiento"])){
            ...
            while($row = mysqli_fetch_array($result)) {
                if ($row['Rol'] == "Admin" || $row['Rol'] == "Lab") {
                    ...
                    mysqli_close($con);
                    //////////////////////////////////////////////////////
                    echo "<script type='text/javascript'>window.top.location='/DesarrolloSoftware/Equipos/modificarEquipo.php';</script>"; exit;
                }else{
