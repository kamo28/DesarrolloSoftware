...
<style>
    ...
    <form method="GET" action="guardar.php">
       ...
       <label for="absorcion"><h4> Absorción de agua (%):</h4></label>
        <input type="number" class="form-control" name="absorcion" required>
        ...
        <input type="number" class="form-control" name="estabilidad" required>
        <label for="aflojamiento"><h4> Aflojamiento (UF):</h4></label>
        <input type="number" class="form-control" name="aflojamiente" required>
        <label for="quality"><h4> Quality Number:</h4></label>
        <input type="number" class="form-control" name="quality" required>
        <h2><u>Alveografo</u></h2>
        <label for="tenacidad"><h4> Tenacidad(P mm):</h4></label>
        <input type="number" class="form-control" name="tenacidad" required>
        <label for="extensibilidad"><h4>Extensibilidad (L mm):</h4></label>
        <input type="number" class="form-control" name="extensibilidad" required>
        <label for="energia"><h4>Energía de la harina (W Jules):</h4></label>
        <input type="number" class="form-control" name="energia" required>
        <label for="elasticidad"><h4> Índice de elasticidad (I.E):</h4></label>
        <input type="number" class="form-control" name="elasticidad" required>
        <?php
    }
    else{
        ?>
       ...
       <label for="absorcion"><h4> Absorción de agua (%):</h4></label>
        ...
        <input type="number" class="form-control" name="estabilidad" required>
        <label for="aflojamiento"><h4> Aflojamiento (UF):</h4></label>
        <input type="number" class="form-control" name="aflojamiento" required>
        <label for="quality"><h4> Quality Number:</h4></label>
        <input type="number" class="form-control" name="quality" required>
        <h2><u>Alveografo</u></h2>
        <label for="tenacidad"><h4> Tenacidad(P mm):</h4></label>
