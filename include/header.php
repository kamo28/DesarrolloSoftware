      ...
      <ul class="navbar-nav ml-auto">
          ...
          <div class="dropdown-menu" aria-labelledby="navbarDropdown">
            <?php
              if ($_SESSION['rol'] == "Admin") {
                echo '<a class="dropdown-item" href="../Equipos/altaEquipo.php">Equipos de laboratorio</a>';
                echo '<a class="dropdown-item" href="../Clientes/Cliente.php">Clientes</a>';
                echo '<a class="dropdown-item" href="../Usuarios/altaUsuarios.php">Usuarios/Laboratoristas</a>';
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu" aria-labelledby="navbarDropdown">
            <?php
              if ($_SESSION['rol'] == "Admin") {
                echo '<a class="dropdown-item" href="../almacenista/estatus_ana.php">Solicitar/Checar análisis</a>';
                echo '<a class="dropdown-item" href="../laboratorista/ana_solicitados.php">Realizar/Guardar análisis</a>';
              }elseif($_SESSION['rol'] == "Almacen"){
                echo '<a class="dropdown-item" href="../almacenista/estatus_ana.php">Solicitar/Checar análisis</a>';
              }elseif($_SESSION['rol'] == "Lab"){
                echo '<a class="dropdown-item" href="../laboratorista/ana_solicitados.php">Realizar/Guardar análisis</a>';
          ...
          <div class="dropdown-menu" aria-labelledby="navbarDropdown">
            <?php
              if ($_SESSION['rol'] == "Admin" || $_SESSION['rol'] == "Almacen") {
                echo '<a class="dropdown-item" href="../almacenista/certificados.php">Emisión de certificados</a>';
              }elseif($_SESSION['rol'] == "Lab"){
